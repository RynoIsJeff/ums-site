  ...
  return (
    <form action={formAction} className="space-y-4 rounded-xl border border-[var(--hub-border-light)] bg-white p-6 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[var(--hub-text)]">Connect ad account</h2>
      ...
      <div>
        <label htmlFor="clientId" className="block text-sm font-medium text-[var(--hub-text)]">
          Client *
        </label>
        <select
          id="clientId"
      ...
      <div>
        <label htmlFor="accountId" className="block text-sm font-medium text-[var(--hub-text)]">
          Ad account ID *
        </label>
        <input
          id="accountId"
      ...
      <div>
        <label htmlFor="accountName" className="block text-sm font-medium text-[var(--hub-text)]">
      ...
      <div>
        <label htmlFor="accessToken" className="block text-sm font-medium text-[var(--hub-text)]">
