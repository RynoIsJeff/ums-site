...
export default async function SocialPagesPage() {
  ...
  return (
    <section className="py-6">
      ...
      {pages.length === 0 && (
        <div className="mt-12 rounded-xl border-2 border-dashed border-[#e4e6eb] bg-[#f7f8fa] p-12 text-center">
          <p className="text-base font-medium text-[#050505]">No Facebook pages connected</p>
      ...
      <div className="mt-12 max-w-xl">
        <h2 className="text-lg font-semibold text-[#050505]">Connect new page</h2>
        <p className="mt-1 text-sm text-[#65676b] mb-4">
